...
<div className="diagnosisContainer">
  ...
  <p>
    Accuracy: <span className="accuracy-highlight">{diagnosis.accuracy}%</span>
  </p>

  <div className="buttons">
    <button onClick={() => onValidate(diagnosis.id, true)}>
      Valid
    </button>
    <button onClick={() => onValidate(diagnosis.id, false)}>
      Invalid
    </button>
  </div>
</div>
